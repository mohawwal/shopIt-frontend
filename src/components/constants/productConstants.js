...
export const PRODUCT_FOR_CATEGORY_REQUEST = 'PRODUCT_FOR_CATEGORY_REQUEST'
export const PRODUCT_FOR_CATEGORY_SUCCESS = 'PRODUCT_FOR_CATEGORY_SUCCESS'
export const PRODUCT_FOR_CATEGORY_FAIL = 'PRODUCT_FOR_CATEGORY_FAIL'
